function showTime() {
    ...
    var startDate = new Date(2021, 02, 19);
    ...
    if (seconds < 10)
        seconds = "0" + seconds;
    var currentTimeString = "Dear yanhong:<br>" +
        ...
        "<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----xiaoxu  2021-03-19</c>";
